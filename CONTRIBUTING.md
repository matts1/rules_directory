...
some other ruleset that depends on rules_directory, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_directory=$(pwd)/rules_directory"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_directory` on your system will point to this folder.
